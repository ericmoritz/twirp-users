...
const UsersPathPrefix = "/twirp/ericmoritz.users.users.Users/"

func (s *usersServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "ericmoritz.users.users")
	...
	switch req.URL.Path {
	case "/twirp/ericmoritz.users.users.Users/Register":
		s.serveRegister(ctx, resp, req)
		return
	case "/twirp/ericmoritz.users.users.Users/Login":
		s.serveLogin(ctx, resp, req)
		return
	case "/twirp/ericmoritz.users.users.Users/User":
		s.serveUser(ctx, resp, req)
		return
	case "/twirp/ericmoritz.users.users.Users/CurrentUser":
